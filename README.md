...
![Imagem](https://github.com/rafacvs/my-go-framework/edit/master/imagem1.png)

Em seguida, é inicializado o frontend.

![Imagem](https://github.com/rafacvs/my-go-framework/edit/master/imagem2.png)

E por fim, a execução da aplicação já em funcionamento, exibindo a listagem de usuários obtida a partir da API.

![Imagem](https://github.com/rafacvs/my-go-framework/edit/master/imagem3.png)
